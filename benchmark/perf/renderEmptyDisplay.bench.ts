...
async function main() {
	...
	bench.add("Create empty display", () => {
		createEmptyDisplay();
	});
	...
	writeFileSync("perf/renderEmptyDisplay.result.json", JSON.stringify(benchResult, null, 2));
	console.log("Benchmark renderEmptyDisplay saved");
}
